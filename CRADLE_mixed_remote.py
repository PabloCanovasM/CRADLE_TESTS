...
SM_39Ca_polZpos = Ca39_data_analysis("build/39Ca_cvca_imag.txt")
SM_39Ca_polZpos.event_mask()
SM_39Ca_polZpos.kinematical_data()
SM_39Ca_polZpos.kinematical_data_ref()
SM_39Ca_polZpos.theoretical_dist(cvca_imag)
SM_39Ca_polZpos.plot_distribution_histograms(showTheory=True,bins=100,fileName="39Ca_cvca_imag",lwidth=1)
