...
for l in l_list:
    for cs in cs_list:
        for ct in ct_list:
            ...
            couplingConstants[:4] = [cs, -cs, ct*1j, -ct*1j]
            ...
            run_array_39Ca = ["./CRADLE++", "nucleus", "-n", "39Ca", "-Z", "20", "-A", "39", "general", "-l", str(l), "-t", "20", "-v", "1", "-o", f"build/39Ca_cs_{cs:0.2f}ct_{ct:0.2f}j_R.txt", "betaDecay","-E", "0", "-r", "0", "--PolarisationZ", "1", "--PolarisationMag", str(1), "--Alignment", str(1), "coupling"]
            run_array_39Ca.extend(couplingConstans_array)
            subprocess.run(run_array_39Ca)
            run_array_23Mg = ["./CRADLE++", "nucleus", "-n", "23Mg", "-Z", "12", "-A", "23", "general", "-l", str(l), "-t", "20", "-v", "1", "-o", f"build/23Mg_cs_{cs:0.2f}ct_{ct:0.2f}j_R.txt", "betaDecay","-E", "0", "-r", "0", "--PolarisationZ", "1", "--PolarisationMag", str(1), "--Alignment", str(1), "coupling"]
